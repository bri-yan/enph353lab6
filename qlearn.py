...
class QLearn:
    def __init__(self, actions, epsilon, alpha, gamma):
        ...
        self.filepath = "/home/fizzer/enph353_gym-gazebo/examples/gazebo_lab06/qstates/"
    ...
    def loadQ(self, filename):
        ...
        pickle_file = open(self.filepath+filename+".pickle", "rb")
    ...
    def saveQ(self, filename):
        ...
        pickle_file = open(self.filepath+filename+".pickle", "wb")
        pickle.dump(self.q, pickle_file)
        pickle_file.close()

        csv_file = open(self.filepath+filename+".csv", 'w')
